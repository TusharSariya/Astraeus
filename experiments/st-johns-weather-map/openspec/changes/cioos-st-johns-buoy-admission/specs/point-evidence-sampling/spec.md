...
pair. It SHALL NOT compare a provider-published precise row coordinate to the
nominal metadata coordinate. A missing station name, mixed/non-finite
coordinate pair, identity mismatch or unacceptable selected time SHALL produce
