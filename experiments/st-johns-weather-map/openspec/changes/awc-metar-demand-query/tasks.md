...
- [ ] Reconcile every retained native field and absence through normalized point evidence and the existing UI.
- [ ] Prove Linux bounds, real provider miss/hit, API/Brief/Workbench readback, unavailable paths, and no scheduled provider request.
- [ ] Run focused and full API, registry, web, OpenSpec strict, and specctl gates; retain exact logs.
