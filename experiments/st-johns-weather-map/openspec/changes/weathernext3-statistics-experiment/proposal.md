# WeatherNext 3 statistics experiment

## Why

The approved account sample proves bounded access to WeatherNext 3 statistics,
but no source-specific contract states what an isolated adapter may preserve or
