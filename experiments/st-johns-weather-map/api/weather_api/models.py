...
class Provenance(StrictModel):
    ...
    lightning_acquisition: LightningAcquisition | None = None
...
class PointResponse(StrictModel):
    ...
    observation_unavailable: list[AQHIDemandUnavailable | LightningDemandUnavailable] = Field(default_factory=list)
    data_mode: DataMode = DataMode.FIXTURE
    operational: Literal[False] = False
    latitude: float
    longitude: float
