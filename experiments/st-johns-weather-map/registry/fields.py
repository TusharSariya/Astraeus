...
SOURCE_FIELDS: list[dict[str, Any]] = [
    ...
    *[_sf("noaa-goes-east", f"cloud_fraction_layer_{index}", f"ABI-L2-CCLF CF{index}", "stored",
    ...
    _sf("eccc-lightning", "lightning_observed", "Lightning_2.5km_Density", "available-not-stored",
        "Exact-frame GeoMet demand query; an interval with no flashes is a complete answer."),
    _sf("eccc-lightning", "lightning_strike", "Lightning_2.5km_Density", "available-not-stored",
        "Exact-frame GeoMet demand density in flash km-2 min-1, from the layer's own 'flash/km2/min'."),
