...
def registry() -> dict[str, Any]:
    ...
    s.extend([
        ...
        _source(
            ...
            ["temperature_2m_mean"], ["2 m"], "Configured historical run; nearest native Avalon cell", "Exact hourly provider lead", "Configured historical run only",
            ...
            {"licence": {"name": "Historical-only experimental scope; conservative valid-time age strictly greater than 48 hours", "url": "https://developers.google.com/weathernext/guides/disclaimers", "review_state": "restricted"},
             "attribution": "WeatherNext data provided by Google",
             "caching": "Bounded historical point cache only; fixed 60-second receipt expiry.",
            ...
            "Non-primary historical temperature comparison", (False, "google-weathernext-3", "Historical provider statistics are excluded from forecast consensus."),
