...
def _eccc_model(id: str, category: str, product: str, doc_slug: str, names: list[str], levels: list[str], cadence: str, horizon: str, role: str, eligible: bool, family: str = "ECCC", endpoints: list[str] | None = None, reason: str | None = None, status: str | None = None, fixture: str | None = None, live: str = "planned", integration: tuple[str, str] | None = None, **horizon_fields: Any) -> dict[str, Any]:
