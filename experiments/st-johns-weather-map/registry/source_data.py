...
def registry() -> dict[str, Any]:
    ...
    s.extend([
        ...
        _source(
            "noaa-swpc-rtsw", "space_weather", *_admission("noaa-swpc-rtsw", "Official SWPC real-time solar wind magnetometer JSON is public; the feed's own source field names the measuring spacecraft."),
    ...
    s.extend([
        ...
        _source("provincial-hydrometric", "hydrology", "licence-blocked", "No stable authoritative provincial machine endpoint has yet been verified for the selected Avalon stations.", "Government of Newfoundland and Labrador", "Provincial hydrometric network", ["https://www.gov.nl.ca/ecc/waterres/flooding/hydrometric/"], ["https://www.gov.nl.ca/ecc/waterres/flooding/hydrometric/"], ("link_only", "Link-only pending a stable machine endpoint"), ["water_level", "discharge", "station_metadata", "quality_flags"], ["gauging station"], "Newfoundland and Labrador", "unknown", "observations only", (False, "Unknown", None), {**optional_policy, "licence": {"name": "Government of Newfoundland and Labrador site/data terms", "url": "https://www.gov.nl.ca/disclaimer/", "review_state": "pending"}}, "unknown", "unknown", "Candidate supplemental hydrology", (False, None, "Not active and not blended."), "blocked", "blocked", delivery_kind="published_cell"),
