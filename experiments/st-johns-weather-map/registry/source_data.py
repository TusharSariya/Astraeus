...
def registry() -> dict[str, Any]:
    ...
    s.extend([
        ...
        _source("eccc-lightning", "lightning", *_admission("eccc-lightning", "Official ten-minute density is queried only for an exact GeoMet-advertised native frame; a native empty answer remains an observed zero."), "Environment and Climate Change Canada", "Lightning flash density", ["https://eccc-msc.github.io/open-data/msc-data/lightning/readme_lightning_en/"], ["https://geo.weather.gc.ca/geomet/"], ("typed_adapter", "bounded GeoMet WMS GetCapabilities and GetFeatureInfo via httpx"), ["lightning_observed", "lightning_strike"], ["10-minute gridded accumulation"], "Canada", "10 minutes", "observations only", (False, "Anonymous HTTPS", None), {**ECCC_POLICY, "caching": "Finite source-local selected-time cache only; no complete-run prefetch or retained raw body.", "archival": "No lightning archive; retain only bounded request/transport metadata for an expired failed refresh."}, "GeoMet Lightning_2.5km_Density WMS schema and advertised TIME extent", "25 minutes", "Observed lightning evidence", (False, None, "Lightning is not blended."), delivery_kind="published_cell", reach=OBSERVED_INSTANT, native_cadence_seconds=600),
