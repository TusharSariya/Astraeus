...
def registry() -> dict[str, Any]:
    ...
    s.extend([
        _eccc_model("eccc-hrdps", "deterministic_forecast", "HRDPS raw", "nwp_hrdps", ["air_temperature", "relative_humidity", "specific_humidity", "dew_point", "wind_u", "wind_v", "gust", "mean_sea_level_pressure", "precipitation_rate", "precipitation_accumulation", "precipitation_type", "total_cloud", "low_cloud", "middle_cloud", "high_cloud", "visibility", "cloud_base", "CAPE", "CIN", "boundary_layer_height", "vertical_velocity", "cloud_liquid_water", "cloud_ice", "soil_temperature", "soil_moisture", "snow_depth", "surface_fluxes"], ["surface", "2 m", "10 m", "height levels", "isobaric levels through at least 300 hPa", "entire atmosphere column", "soil layers"], "4 runs/day; product-dependent hourly output", "approximately 48 h; use only +24 h in this POC", "Primary high-resolution deterministic forecast and explicit first fallback", True),
        ...
        _eccc_model("eccc-rdps", "deterministic_forecast", "RDPS", "nwp_rdps", ["temperature", "dew_point", "relative_humidity", "specific_humidity", "wind", "gust", "pressure", "precipitation", "cloud", "visibility", "CAPE", "CIN", "soil_and_surface_state"], ["surface", "2 m", "10 m", "height", "isobaric", "column", "soil"], "4 runs/day; product-dependent steps", "approximately 84 h", "Regional comparison and explicit second fallback", True),
        _eccc_model("eccc-reps", "ensemble", "REPS all members and control", "nwp_reps", ["temperature", "humidity", "wind", "precipitation", "pressure", "cloud", "threshold_occurrence"], ["surface", "2 m", "10 m", "isobaric", "column", "member and control (21 members, GeoMet REPS.MEM.<VAR>.01-21)"], "4 runs/day; product-dependent steps", "approximately 72 h", "ECCC regional ensemble distributions; retain all members", False, endpoints=["https://geo.weather.gc.ca/geomet/"], reason='Probed 2026-09-02: absent from the open HTTP tree. https://dd.weather.gc.ca/today/model_reps/ and .../today/ensemble/reps/ are 404 on dd.weather.gc.ca and on the hpfx.collab.science.gc.ca mirror, whose ensemble/ tree holds only cansips and doc. Reachable through GeoMet, which publishes 1239 individual member coverages as REPS.MEM.<VAR>.<NN> for members 01-21 in both WMS and WCS, including ETA_TT, ETA_HR, ETA_NT, ETA_PN and ETA_WSPD; there is no ETA_UU or ETA_VV, so members carry wind speed without direction. MetPX Sarracenia over AMQP is the one open route not yet probed.'),
        _eccc_model("eccc-gdps", "deterministic_forecast", "GDPS", "nwp_gdps", ["temperature", "humidity", "wind", "pressure", "precipitation", "cloud", "surface_state"], ["surface", "2 m", "10 m", "isobaric", "column", "soil"], "2 runs/day", "10 days", "Broader Canadian deterministic context", True),
        _eccc_model("eccc-geps", "ensemble", "GEPS ensemble statistics (no members published openly)", "nwp_geps", ["temperature", "humidity", "wind", "pressure", "precipitation", "cloud", "threshold_occurrence"], ["surface", "2 m", "10 m", "isobaric", "column", "provider reduction only: mean, spread, percentiles, threshold probabilities"], "2 runs/day", "16 days; extended 39-day anomalies twice weekly", "Provider-published ensemble statistics; stored as retrieved, never recomputed here", False, endpoints=["https://geo.weather.gc.ca/geomet/"], reason="Probed 2026-09-02: absent from the open HTTP tree. https://dd.weather.gc.ca/today/model_geps/ and .../today/ensemble/geps/grib2/ are 404 on dd.weather.gc.ca and on the hpfx.collab.science.gc.ca mirror, and MSC's own product readme still documents the dead path. Reachable through GeoMet, but GeoMet publishes NO GEPS members at all: only the provider's own reduction as GEPS.DIAG.* - ERMEAN, ERSSTD, percentiles ERC0 to ERC100, and threshold probabilities. Store those as retrieved; never recompute them here. MetPX Sarracenia over AMQP is the one open route not yet probed."),
        _eccc_model("eccc-integrated-nowcasting", "nowcasting", "Integrated Nowcasting System", "nwp_nowcasting", ["precipitation_probability", "precipitation_rate", "lightning_probability", "cloud_fraction", "surface_weather_elements"], ["surface forecast points/matrices"], "hourly", "12 h", "Source-specific observation-informed nowcast", False),
        ...
        _eccc_model("eccc-rdwps", "wave", "RDWPS", "nwp_rdwps", ["significant_wave_height", "wind_wave_height", "swell_height", "wave_direction", "wave_period"], ["sea surface"], "Product-dependent", "regional wave forecast", "Deterministic wave evidence", False),
        _eccc_model("eccc-rewps", "wave", "REWPS", "nwp_rewps", ["wave_height", "wave_direction", "wave_period", "ensemble_uncertainty"], ["sea surface", "ensemble member"], "Product-dependent", "regional wave forecast", "Wave ensemble uncertainty", False),
    ...
    s.extend([
        _source("eccc-swob", "surface_observation", "implementing", "Official SWOB-ML feed and v8.16 guide are available; adapter is not yet implemented.", "Environment and Climate Change Canada", "SWOB-ML surface and marine observations", ["https://dd.weather.gc.ca/20260423/WXO-DD/observations/doc/SWOB-ML_Product_User_Guide_v8.16_e.pdf"], [f"{ECCC_DATAMART}observations/swob-ml/"], ("typed_adapter", "httpx + Pydantic XML adapter"), ["air_temperature", "dew_point", "relative_humidity_when_published", "wind", "gust", "pressure", "visibility", "present_weather", "cloud_amount", "cloud_base", "wave_height", "sea_state", "SST", "quality_flags"], ["station surface", "cloud layers", "marine surface"], "Canada; filter CYYT, nearby Avalon stations and official marine platforms", "station-dependent, minute to hourly", "observations only", (False, "Anonymous HTTPS", None), ECCC_POLICY, "SWOB-ML Product User Guide 8.16 / product_generic_swob-xml-2.0", "90 minutes for hourly stations; retain provider cadence metadata", "Primary official surface/humidity observation evidence", (False, None, "Observations do not vote in forecast consensus.")),
        _source("eccc-radiosonde", "humidity_profile", "implementing", "Official upper-air observations are catalogued; station selection and decoder remain to implement.", "Environment and Climate Change Canada", "Upper-air radiosonde observations", [ECCC_CATALOGUE], [f"{ECCC_DATAMART}observations/upper_air/"], ("raw_protocol", "official TEMP/BUFR protocol decoded with ecCodes"), ["pressure", "temperature", "dew_point", "relative_humidity", "wind_u", "wind_v", "height", "quality_flags"], ["reported mandatory and significant levels from surface through at least 300 hPa"], "Canadian upper-air stations applicable to Newfoundland", "typically 00 and 12 UTC; station-dependent", "observations only", (False, "Anonymous HTTPS", None), ECCC_POLICY, "WMO TEMP/BUFR edition discovered from artifact", "15 h", "Observed vertical humidity and wind profile", (False, None, "Observations do not vote in forecast consensus.")),
        _source("eccc-radar", "radar", "implementing", "Official composite/rate/type and extrapolation products exist; no-echo semantics must be fixture-tested.", "Environment and Climate Change Canada", "Weather radar composite and extrapolation", ["https://eccc-msc.github.io/open-data/msc-data/obs_radar/readme_radar_en/", "https://eccc-msc.github.io/open-data/faq/readme_en/"], ["https://geo.weather.gc.ca/geomet/"], ("raw_protocol", "OWSLib WMS/WCS plus GeoTIFF adapter"), ["radar_precipitation_rate", "radar_precipitation_type", "radar_extrapolation", "coverage_mask", "no_echo"], ["radar mosaic surface projection"], "North American/Canadian radar coverage; crop Avalon", "approximately 6-10 minutes, collection-dependent", "short extrapolation only", (False, "Anonymous OGC services", None), ECCC_POLICY, "GeoMet collection metadata at activation", "20 minutes", "Observed precipitating-echo evidence; no echo never means clear sky", (False, None, "Radar is observation/nowcast evidence and is not blended into NWP consensus.")),
        _source("eccc-lightning", "lightning", "implementing", "Official ten-minute density product exists; collection and geometry fixtures remain.", "Environment and Climate Change Canada", "Lightning flash density", ["https://eccc-msc.github.io/open-data/msc-data/lightning/readme_lightning_en/"], [f"{ECCC_DATAMART}observations/lightning/"], ("raw_protocol", "official GeoTIFF protocol via rasterio"), ["lightning_flash_density", "coverage_mask"], ["10-minute gridded accumulation"], "Canada", "10 minutes", "observations only", (False, "Anonymous HTTPS", None), ECCC_POLICY, "ECCC lightning GeoTIFF product version discovered from metadata", "25 minutes", "Observed lightning evidence", (False, None, "Lightning is not blended.")),
        _source("eccc-cap-alerts", "hazard", "implementing", "Official CAP alert feed is available; alert revision/expiry fixtures remain.", "Environment and Climate Change Canada / authorized alert issuers", "Common Alerting Protocol weather alerts", ["https://eccc-msc.github.io/open-data/msc-data/alerts/readme_alerts_en/"], [f"{ECCC_DATAMART}alerts/cap/"], ("typed_adapter", "httpx + defusedxml CAP adapter"), ["event", "severity", "urgency", "certainty", "onset", "expires", "instruction", "area_geometry", "identifier", "references"], ["alert polygon/geocode"], "Canada; filter Newfoundland and adjacent marine areas", "event-driven", "validity interval in alert", (False, "Anonymous HTTPS/AMQP", None), ECCC_POLICY, "CAP-CP as declared in each message", "15 minutes after issue/update", "Official warning layer; never numerically blended", (False, None, "Warnings are authoritative categorical evidence, not model votes.")),
        _source("eccc-thunderstorm-outlooks", "hazard", "implementing", "Official outlook candidate is catalogued but exact machine collection must be pinned.", "Environment and Climate Change Canada", "Thunderstorm outlooks", ["https://eccc-msc.github.io/open-data/msc-data-themes/thunderstorms_en/"], [ECCC_API], ("typed_adapter", "httpx + Pydantic OGC API adapter"), ["thunderstorm_outlook_category", "validity", "geometry"], ["forecast area/polygon"], "Canada where issued", "issuance-dependent", "product validity", (False, "Anonymous OGC API", None), ECCC_POLICY, "GeoMet collection schema to pin", "one issue cycle", "Supporting human-authored severe-weather guidance", (False, None, "Human guidance is not an independent NWP vote.")),
        _source("eccc-hurricane-products", "hazard", "implementing", "Used only when official products are active; exact collection is season/event dependent.", "Canadian Hurricane Centre / ECCC", "Hurricane bulletins, tracks and watches/warnings", ["https://weather.gc.ca/hurricane/index_e.html", ECCC_CATALOGUE], [ECCC_API], ("typed_adapter", "httpx + Pydantic OGC/CAP adapter"), ["storm_identity", "track", "forecast_positions", "wind_extent", "watch_warning", "validity", "uncertainty"], ["point", "track", "polygon"], "Canadian Atlantic responsibility area", "advisory-dependent", "advisory validity", (False, "Anonymous HTTPS", None), ECCC_POLICY, "Product/CAP version per message", "one advisory cycle", "Event-driven official tropical-cyclone context", (False, None, "Hazards are not blended.")),
        _source("eccc-aqhi", "air_quality", "implementing", "Official real-time observations and forecasts are exposed by GeoMet; adapter remains.", "Environment and Climate Change Canada", "Air Quality Health Index observations and forecasts", [ECCC_CATALOGUE, "https://api.weather.gc.ca/collections/aqhi-observations-realtime"], ["https://api.weather.gc.ca/collections/aqhi-observations-realtime/items"], ("typed_adapter", "httpx + Pydantic OGC API Features adapter"), ["AQHI", "observation_or_forecast_indicator", "valid_time", "station_or_region"], ["station point", "forecast region"], "Canada; select St. John's/Avalon", "hourly observations; forecast issuance-dependent", "forecast collection validity", (False, "Anonymous OGC API", None), ECCC_POLICY, "live OGC collection schema", "2 h observation; one forecast issue cycle", "AQHI only; never substitute for PM, AOD or extinction", (False, None, "Air-quality indices are not weather consensus fields.")),
        _source("eccc-raqdps", "air_quality", "implementing", "Operational RAQDPS is in the current catalogue; variables must be selected from the current product inventory.", "Environment and Climate Change Canada", "RAQDPS", [ECCC_CATALOGUE], [f"{ECCC_DATAMART}model_raqdps/", ECCC_API], ("raw_protocol", "ecCodes/cfgrib or OGC coverage adapter"), ["PM1", "PM2.5", "PM10", "ozone", "NO2", "other_published_species", "smoke_related_fields", "wildfire_hotspot_inputs"], ["surface", "model vertical levels where published", "column where published"], "North America/Canada product domain", "operational cycles; product-dependent", "operational air-quality horizon", (False, "Anonymous HTTPS/OGC", None), ECCC_POLICY, "current RAQDPS GRIB2/GeoMet schema", "two nominal cycles", "Source-specific air-quality forecast", (False, None, "Not semantically interchangeable with AQHI/AOD/extinction or weather consensus.")),
        _source("eccc-rdaqa", "air_quality", "implementing", "Operational RDAQA analysis is in the current catalogue; decoder remains.", "Environment and Climate Change Canada", "RDAQA", [ECCC_CATALOGUE], [ECCC_API], ("raw_protocol", "OGC coverage or official GRIB2 adapter"), ["PM2.5", "PM10", "ozone", "NO2", "other_published_species", "analysis_quality"], ["surface analysis grid"], "Canadian air-quality analysis domain", "product-dependent", "analysis, not forecast", (False, "Anonymous OGC", None), ECCC_POLICY, "current RDAQA collection schema", "two analysis cycles", "Air-quality analysis", (False, None, "Analysis is not forecast consensus.")),
        _source("eccc-wildfire-hotspots", "air_quality", "implementing", "Official Canadian hotspot feed is catalogued; detection confidence/QC mapping remains.", "Natural Resources Canada / ECCC distribution", "Canadian Wildland Fire Information System hotspots", ["https://cwfis.cfs.nrcan.gc.ca/downloads/hotspots/"], ["https://cwfis.cfs.nrcan.gc.ca/downloads/hotspots/"], ("typed_adapter", "httpx geospatial feature adapter"), ["hotspot_location", "detection_time", "confidence", "satellite", "fire_radiative_power_when_published"], ["point detections"], "Canada", "satellite-pass dependent", "observations only", (False, "Anonymous HTTPS", None), ECCC_POLICY, "CWFIS hotspot schema at activation", "one applicable satellite pass", "Smoke/fire context, not proof of surface PM", (False, None, "Detection context is not blended.")),
        _source("eccc-raqdps-firework", "air_quality", "retired", "The standalone RAQDPS-FireWork feed is listed under retired open data and must not be requested; smoke is incorporated into RAQDPS.", "Environment and Climate Change Canada", "RAQDPS-FireWork standalone", ["https://eccc-msc.github.io/open-data/msc-data/nwp_raqdps-fw/readme_raqdps-fw_en/", ECCC_CATALOGUE], [f"{ECCC_DATAMART}model_raqdps-fw/"], ("raw_protocol", "No client; endpoint retained only as historical registry evidence"), ["historical_smoke_and_air_quality_fields"], ["historical surface/model levels"], "Historical North American product domain", "retired", "none", (False, "No access should be attempted", None), ECCC_POLICY, "retired product", "not applicable", "Registry tombstone only", (False, None, "Retired product cannot contribute."), "not_applicable", "not_applicable"),
        _source("eccc-marine-buoys-synop", "marine_observation", "implementing", "SWOB guide documents MSC and DFO moored buoy sources; station QC/identity fixtures remain.", "Environment and Climate Change Canada and Fisheries and Oceans Canada", "Official marine, ship, buoy SYNOP/SWOB observations", ["https://dd.weather.gc.ca/20260423/WXO-DD/observations/doc/SWOB-ML_Product_User_Guide_v8.16_e.pdf"], [f"{ECCC_DATAMART}observations/swob-ml/", f"{ECCC_DATAMART}observations/marine/"], ("typed_adapter", "SWOB XML and official SYNOP/BUFR adapter"), ["air_temperature", "dew_point", "relative_humidity_when_published", "wind", "pressure", "SST", "wave_height", "wave_period", "wave_direction", "visibility", "present_weather", "quality_flags"], ["marine platform surface", "wave groups"], "Official platforms in Newfoundland and upstream Atlantic waters", "platform-dependent", "observations only", (False, "Anonymous HTTPS", None), ECCC_POLICY, "SWOB-ML 8.16 plus WMO message version", "2 h", "Official marine observations", (False, None, "Observations are not forecast votes.")),
        _source("eccc-marine-forecasts-alerts", "marine", "implementing", "Official marine forecasts and warnings are accessible; machine collection/revision handling remains.", "Environment and Climate Change Canada", "Marine forecasts, warnings and coastal-flooding guidance", ["https://weather.gc.ca/marine/index_e.html", ECCC_CATALOGUE], [ECCC_API, f"{ECCC_DATAMART}alerts/cap/"], ("typed_adapter", "httpx OGC/CAP adapter"), ["marine_forecast_text", "wind", "visibility", "freezing_spray", "wave_guidance", "warning", "coastal_flooding_risk", "validity"], ["marine forecast area", "alert polygon"], "Newfoundland marine forecast areas", "issuance/event dependent", "published validity", (False, "Anonymous HTTPS", None), ECCC_POLICY, "CAP/product version in payload", "one issue cycle", "Human-authored marine guidance and hazards", (False, None, "Guidance and warnings are not blended.")),
        _source("eccc-hydrometric", "hydrology", "implementing", "GeoMet exposes real-time hydrometric collections; station relevance selection remains.", "Environment and Climate Change Canada / Water Survey of Canada", "Real-time hydrometric stations", ["https://eccc-msc.github.io/open-data/usage/use-case_oafeat/use-case_oafeat-interactive_en/"], ["https://api.weather.gc.ca/collections/hydrometric-realtime/items"], ("generated_client", "Generate from https://api.weather.gc.ca/openapi after pinning a stable document; otherwise typed httpx adapter"), ["water_level", "discharge", "station_metadata", "quality_or_provisional_flags", "observation_time"], ["gauging station point"], "Canada; select relevant Avalon catchments", "station-dependent near-real-time", "observations only", (False, "Anonymous OGC API", None), ECCC_POLICY, "live GeoMet OpenAPI/collection schema", "3 h unless provider cadence indicates otherwise", "Official hydrometric observations", (False, None, "Hydrology is source-specific.")),
    ])
    ...
    s.extend([
        ...
        _source("nav-canada-weather-cameras", "camera", "licence_review", "Keep link-only until automated access and display/redistribution rights are confirmed.", "NAV CANADA", "Weather cameras", ["https://weathercams.navcanada.ca/"], ["https://weathercams.navcanada.ca/"], ("link_only", "Browser link only; no scraping or image proxy"), ["camera_page_link", "location", "nominal_direction"], ["camera viewpoint"], "Canadian aerodromes where cameras are offered", "unknown/display dependent", "current image only", (False, "Public browser page; machine access not authorized", None), {"licence": {"name": "NAV CANADA site terms", "url": "https://www.navcanada.ca/en/terms-of-use.aspx", "review_state": "pending"}, "attribution": "Link to NAV CANADA only.", "caching": "No image caching.", "archival": "No image archival.", "redistribution": "No image redistribution until written rights review passes."}, "website", "unknown", "Link-only visual context", (False, None, "Cameras are not blended."), "not_applicable", "not_applicable"),
    ])
