        ...
        try:
            for kind, url, maximum in requests:
                ...
                artifacts.append(Artifact(kind, media, output, {
                    ...
                    "field_interpretation": {"format": "GeoJSON and JSON object syntax validated only", "values": "verbatim native source strings or JSON values", "units": "uncontracted", "times": "verbatim, not normalized", "masks": "uncontracted", "quality": "uncontracted"},
        ...
        try:
            for sensor in self._sensors:
                ...
                artifacts.append(Artifact(f"firms_{sensor}_canada_24h", "text/csv", output, {
                    ...
                    "field_interpretation": {"format": "UTF-8 CSV header and row widths validated only", "values": "verbatim native CSV strings", "units": "uncontracted", "times": "verbatim, not normalized", "masks": "uncontracted", "quality": "uncontracted"},
                    "source_qc": {"status": "unknown", "flags": ["provider_quality_not_contracted"]},
                    "quality": validation.as_quality(), "operational": False, "adapter_version": self.adapter_version,
                    **declared_classes(["retrieved"]),
                }))
