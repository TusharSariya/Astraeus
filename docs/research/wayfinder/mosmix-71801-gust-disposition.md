...
forecast positions for `FX1` and a DWD missing marker (`-`) at all 247
positions. The same files contain 246 finite `FF` wind-speed positions, so the
files and time axes are populated. DWD defines `FX1` as the maximum wind gust
within the last hour, in `m/s`, in its
...
| Valid-date window | HTTP completion | Bytes | SHA-256 | Rows | Gust disposition |
|---|---|---:|---|---:|---|
| 2026-09-06 04:00–23:00Z | 200, JSON, length matched | 8,609 | `d13a242239bcf5e8a881dd77aa1c738438eb299863c41b2464d157c82349c9e2` | 20 | 0 finite / 20 null |
| 2026-09-07 04:00–23:00Z | 200, JSON, length matched | 8,614 | `d809d408f871909a04dacd85bb4741863585f248c9ff600d4d29276d7f5e44bd` | 20 | 0 finite / 20 null |
| 2026-09-08 04:00–23:00Z | 200, JSON, length matched | 8,647 | `94129bc408a09d964462503635899bafc5afe9a15f49106dddeb39e36fdc30a0` | 20 | 0 finite / 20 null |
| 2026-09-09 04:00–23:00Z | 200, JSON, length matched | 8,612 | `70917fdff0e9385bc33defc706e029726c08a1590adf93a3479e0e98bf6edc4a` | 20 | 0 finite / 20 null |
...
| DWD issue time | Bytes | KMZ SHA-256 | FX1 finite / positions | FF finite / positions |
|---|---:|---|---:|---:|
| 2026-09-04 09Z | 16,723 | `4bfa3b826748f07649bc175c840c04061d381a46aa7d5094a41c244a09a100e8` | 0 / 247 | 246 / 247 |
| 2026-09-04 15Z | 16,581 | `09e376a5b67b3463f730f35bca3236568e4d9977ffa54a62de29324ffebe7967` | 0 / 247 | 246 / 247 |
| 2026-09-04 21Z | 16,726 | `071bb10e2eb5250202f63f1f253e64dcb45e90d66313d4df8e404607ee02ff47` | 0 / 247 | 246 / 247 |
| 2026-09-05 03Z | 16,670 | `b4e1b010882956287eb98193ad488c70ddab2ef2c2be34694314a0ab7422d005` | 0 / 247 | 246 / 247 |
| 2026-09-05 09Z | 16,723 | `7c31fb485796a01dd7f60da7455ce50d8a8c2233aab63144d5d56f9a47310ee0` | 0 / 247 | 246 / 247 |
| 2026-09-05 15Z | 16,546 | `92cd08fe4f7f4a8d9094133db8befe92ecb4f3be07d01f0443bd1cf5cab2f397` | 0 / 247 | 246 / 247 |
| 2026-09-05 21Z | 16,502 | `0ff50f4c0e3db8aaecaacefeaec17f96758aa23b90f7cce68bcc42daebab6dfe` | 0 / 247 | 246 / 247 |
| 2026-09-06 03Z | 16,322 | `53c951d2725f1e27bd6e5312dafb16429979229818d1fb1b8d78adcdb6b5bfbb` | 0 / 247 | 246 / 247 |
...
`/private/tmp/astraeus-issue144-evidence` for independent review. Git contains
only this compact receipt. The capture used four Bright Sky weather requests,
one Bright Sky source request, eight native station-file requests and small
documentation requests. The native path avoided the roughly 80 MiB all-station
files. Individual HTTP bodies were capped at 4 MiB for JSON and 1 MiB for each
station KMZ. Total retained scratch is below 5 MiB, against 36 GiB free disk.
