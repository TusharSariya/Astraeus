...
The actual HTTP document receipts record completion through `2026-09-06T05:33:29.322413Z`; the MetNotes listing completed at `2026-09-06T05:33:29.506617Z`. After the inventory representation was refined, a labeled local replay at `2026-09-06T05:41:20.875433Z` rebuilt only provenance inventories from the retained immutable bodies. It made no network request and retained the original HTTP receipt timestamps, headers, byte counts, and body hashes.
