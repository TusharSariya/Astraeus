> Historical recovery: restored from `d51b88206c52` during the September 8 unused-work audit. This retains the original September 4 research, not current verification or implementation authority. Revalidate time-sensitive claims before reuse; current contracts and merged behavior take precedence.
