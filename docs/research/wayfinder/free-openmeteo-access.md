> Historical recovery: restored from `a9d933d969df` during the September 8 unused-work audit. This retains the original September 5 research, not current verification or implementation authority. Revalidate time-sensitive claims before reuse; current contracts and merged behavior take precedence.
