...
The owner has not selected either. Exact route name, query bounds, field identity, sample limits, pagination/error behavior and snapshot lifetime are subsequent decisions; no arbitrary values are frozen here.
